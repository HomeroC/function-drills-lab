...
const newExlaimTwo = str =>  (str.toUpperCase() + "!!!")

let upperWord = newExlaimTwo("hello")
console.log(upperWord)
upperWord = exclaimTwo("hello")
console.log(upperWord)
////////////////// PROBLEM 9 ////////////////////
...
let nameGreeting = nameCheck("Homero")
